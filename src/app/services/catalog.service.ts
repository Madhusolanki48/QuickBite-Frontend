...
export class CatalogService {
  ...
  private readonly defaultRestaurants: Restaurant[] = [
    ...
    },
    {
      ...
      imageUrl: this.asset(`${this.assetBase}/restaurants/sushi-zen.png`),
    },
    {
      id: 'spice-garden',
      name: 'Spice Garden',
    ...
    },
    {
      ...
      status: 'OPEN',
      heroEmoji: '🥪',
      description: 'Toasted sandwiches, wraps, and coffee.',
      imageUrl: this.asset(`${this.assetBase}/restaurants/urban-cafe.jpg`),
    },
    {
      id: 'green-bowl',
      name: 'Green Bowl',
      ...
      status: 'OPEN',
      heroEmoji: '🥤',
      description: 'Smoothies, juices, and refreshing sips.',
    ...
    },
    {
      ...
      category: 'dessert',
      rating: 4.8,
      deliveryMinutes: '22–32',
      minOrder: 120,
      status: 'OPEN',
      heroEmoji: '🍰',
      description: 'Cakes, sundaes, and indulgent treats.',
      imageUrl: this.asset(`${this.assetBase}/restaurants/sweet-heaven.jpg`),
    },
    {
      id: 'taco-fiesta',
      name: 'Taco Fiesta',
  ...
  private readonly defaultMenuItems: MenuItem[] = [
    ...
    {
      id: 'sweet-1',
      restaurantId: 'sweet-heaven',
      name: 'Belgian Chocolate Pastry',
      description: 'Rich Belgian chocolate layer pastry',
      price: 129,
      rating: 4.8,
      icon: '🍰',
      category: 'Cakes & Pastries',
      imageUrl: this.asset(`${this.assetBase}/food-items/belgian-chocolate-pastry.jpg`),
    },
    {
      id: 'sweet-2',
      restaurantId: 'sweet-heaven',
      name: 'Choco Lava Cake',
      description: 'Warm cake with a liquid chocolate center',
      price: 99,
      rating: 4.9,
      icon: '🧁',
      category: 'Cakes & Pastries',
    ...
    },
    {
      ...
      description: 'Fluffy donut glazed with dark chocolate',
      price: 79,
      rating: 4.6,
      icon: '🍩',
      category: 'Donuts',
      imageUrl: this.asset(`${this.assetBase}/food-items/chocolate-donut.jpg`),
    },
    {
      id: 'sweet-4',
      restaurantId: 'sweet-heaven',
      name: 'Chocolate Mousse Cake',
      description: 'Light and airy chocolate mousse layer cake',
      price: 149,
      rating: 4.7,
      icon: '🎂',
      category: 'Cakes & Pastries',
      imageUrl: this.asset(`${this.assetBase}/food-items/chocolate-mousse-cake.jpg`),
    },
    {
      id: 'sweet-5',
      restaurantId: 'sweet-heaven',
      name: 'Gulab Jamun',
      description: 'Soft milk-solid dumplings in warm cardamom sugar syrup (2 pcs)',
      price: 69,
      rating: 4.9,
      icon: '🍡',
      category: 'Indian Sweets',
      imageUrl: this.asset(`${this.assetBase}/food-items/gulab-jamun.jpg`),
    },
    {
      id: 'sweet-6',
      restaurantId: 'sweet-heaven',
      name: 'Jalebi',
      description: 'Crispy, syrup-filled spiral sweet (100g)',
      price: 59,
      rating: 4.8,
      icon: '🥨',
      category: 'Indian Sweets',
      imageUrl: this.asset(`${this.assetBase}/food-items/jalebi.jpg`),
    },
    {
      id: 'sweet-7',
      restaurantId: 'sweet-heaven',
      name: 'Kaju Katli',
      description: 'Classic cashew fudge sweet (100g)',
      price: 119,
      rating: 4.9,
      icon: '🔷',
      category: 'Indian Sweets',
      imageUrl: this.asset(`${this.assetBase}/food-items/kaju-katli.jpg`),
    },
    {
      id: 'sweet-8',
      restaurantId: 'sweet-heaven',
      name: 'Motichoor Laddu',
      description: 'Soft laddus made with fine gram flour pearls (2 pcs)',
      price: 69,
      rating: 4.7,
      icon: '🟠',
      category: 'Indian Sweets',
      imageUrl: this.asset(`${this.assetBase}/food-items/motichoor-laddu.jpg`),
    },
    {
      id: 'sweet-9',
      restaurantId: 'sweet-heaven',
      name: 'Rasmalai',
      description: 'Soft paneer discs in saffron-infused sweetened milk (2 pcs)',
      price: 89,
      rating: 4.9,
      icon: '🥛',
      category: 'Indian Sweets',
      imageUrl: this.asset(`${this.assetBase}/food-items/rasmalai.jpg`),
    },
  ];
